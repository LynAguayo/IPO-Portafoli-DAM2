...
console.log('%c👋 Hola! Bienvenido a mi portfolio', 'color: #FF006E; font-size: 20px; font-weight: bold;');
console.log('%c💻 Diseñado y desarrollado con ❤️ por Evelyn Aguayo', 'color: #8338EC; font-size: 14px;');